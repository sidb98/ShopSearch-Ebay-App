...
export default function LoadingBar({ loadingProgress, setLoading }) {
  // "Create a component for loading bar that will be displayed when the user is waiting for the response from the server" prompt (25 lines) ChatGPT, 10 Oct. version, OpenAI, 11 Oct. 2023, chat.openai.com/chat.
  useEffect(() => {
