...
export default function ProductsTab({ item }) {
  ...
  // "Open ImageModal component when user clicks on View Product Images button" prompt (7 lines) ChatGPT, 25 Oct. version, OpenAI, 11 Oct. 2023, chat.openai.com/chat.
  ...
  return (
    <div className="container mb-5">
        ...
        <table className="w-100">
          <tbody>
            <tr className="row-odd">
              {/* "How to make the key value pair stacked when on a smaller screen using bootstrap" prompt (2 lines) ChatGPT, 25 Oct. version, OpenAI, 11 Oct. 2023, chat.openai.com/chat. */}
            ...
            {productDetails.Price !== null && (
              ...
              {/* "How to make the key value pair stacked when on a smaller screen using bootstrap" prompt (2 lines) ChatGPT, 23 Oct. version, OpenAI, 11 Oct. 2023, chat.openai.com/chat. */}
      ...
      {/* "Open Image Modal when View Products Image is selected" prompt, (5 lines) ChatGPT, 25 Oct. version, OpenAI, 11 Oct. 2023, chat.openai.com/chat. */}
      {showImageModal && (
        <ImageModal
